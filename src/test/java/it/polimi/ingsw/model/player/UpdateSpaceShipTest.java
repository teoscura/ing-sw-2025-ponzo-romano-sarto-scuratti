...
public class UpdateSpaceShipTest {
	...
	void noComponentsUpdate() {
		...
		assertEquals(2, nocomponents.getSpaceShip().getTotalCrew());
		nocomponents.getSpaceShip().getComponent(new ShipCoords(GameModeType.TEST, 3, 2)).check(v);
		System.out.println(nocomponents.getSpaceShip().getTotalCrew());
		assertEquals(1, nocomponents.getSpaceShip().getTotalCrew());
		nocomponents.getSpaceShip().getComponent(new ShipCoords(GameModeType.TEST, 3, 2)).check(v);
		System.out.println(nocomponents.getSpaceShip().getTotalCrew());
		assertEquals(0, nocomponents.getSpaceShip().getTotalCrew());
		assertEquals(4, nocomponents.getSpaceShip().countExposedConnectors());
	}

	@Test
	void dummy2Update() {
		assertEquals(2, dummy2.getSpaceShip().getTotalCrew());
		assertEquals(0, dummy2.getSpaceShip().getCannonPower());
		dummy2.getSpaceShip().turnOn(new ShipCoords(GameModeType.TEST, 3, 1), new ShipCoords(GameModeType.TEST, 3, 3));
		assertEquals(2, dummy2.getSpaceShip().getCannonPower());
		...
		assertEquals(1, dummy2.getSpaceShip().getTotalCrew());
		//assertTrue( dummy2.getSpaceShip().countExposedConnectors());
	}

	@Test
	void dummy3Update() {
		assertEquals(8, dummy3.getSpaceShip().getTotalCrew());
		assertEquals(0, dummy3.getSpaceShip().getCannonPower());
	...
	void dummy3Update2() {
		...
		assertEquals(7, dummy3.getSpaceShip().getTotalCrew());
		dummy3.getSpaceShip().removeComponent(new ShipCoords(GameModeType.TEST, 4, 4));
		assertEquals(6, dummy3.getSpaceShip().getTotalCrew());
		dummy3.getSpaceShip().removeComponent(new ShipCoords(GameModeType.TEST, 5, 3));
		assertEquals(4, dummy3.getSpaceShip().getTotalCrew());
		assertEquals(0, dummy3.getSpaceShip().getCannonPower());
	...
	@Test
	void dummy4Update() {
		assertEquals(2, dummy4.getSpaceShip().getTotalCrew());
		assertEquals(0, dummy4.getSpaceShip().getCannonPower());
		assertEquals(0, dummy4.getSpaceShip().getEnginePower());
		dummy4.getSpaceShip().turnOn(new ShipCoords(GameModeType.TEST, 3, 3), new ShipCoords(GameModeType.TEST, 2, 2));
		assertEquals(2, dummy4.getSpaceShip().getEnginePower());
		assertEquals(2, dummy4.getSpaceShip().getTotalCrew());
		assertEquals(0, dummy4.getSpaceShip().getCannonPower());
	...
	@Test
	void dummy5Update() {
		assertEquals(2, dummy5.getSpaceShip().getTotalCrew());
		assertEquals(0, dummy5.getSpaceShip().getCannonPower());
		assertEquals(1, dummy5.getSpaceShip().getEnginePower());
	...
	@Test
	void dummy6Update() {
		assertEquals(2, dummy6.getSpaceShip().getTotalCrew());
		System.out.println(dummy6.getSpaceShip().getCannonPower());
		assertEquals(0.5f, dummy6.getSpaceShip().getCannonPower());
		assertEquals(0, dummy6.getSpaceShip().getEnginePower());
		dummy6.getSpaceShip().turnOn(new ShipCoords(GameModeType.TEST, 3, 1), new ShipCoords(GameModeType.TEST, 2, 2));
		assertEquals(0, dummy6.getSpaceShip().getEnginePower());
		assertEquals(2, dummy6.getSpaceShip().getTotalCrew());
		assertEquals(2.5, dummy6.getSpaceShip().getCannonPower());
	}
	...
	void storage() {
		...
		for (int i = 0; i < 5; i++) {
			assertEquals(test[i], storage.getSpaceShip().getContains()[i]);
		}
