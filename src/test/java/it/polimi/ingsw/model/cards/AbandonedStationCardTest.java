...
public class AbandonedStationCardTest {
    ...
    void behaviour() throws ForbiddenCallException{
        ...
        assertTrue(2 == player1.getSpaceShip().getTotalCrew());
        assertTrue(6 == player2.getSpaceShip().getTotalCrew());
        assertTrue(6 == player3.getSpaceShip().getTotalCrew());
        mess = new SelectLandingMessage(0);
        mess.setDescriptor(p1desc);
        state.validate(mess);
        assertTrue(state.getCardState(player1) instanceof AbandonedStationAnnounceState);
        ...
        state.validate(mess);
        assertTrue(state.getCardState(player1) instanceof AbandonedStationRewardState);
        ...
        mess.setDescriptor(p2desc);
        state.validate(mess);
        assertTrue(1 == ((StorageComponent)player2.getSpaceShip().getComponent(new ShipCoords(GameModeType.TEST, 4, 2))).howMany(ShipmentType.YELLOW));
        assertTrue(0 == ((StorageComponent)player2.getSpaceShip().getComponent(new ShipCoords(GameModeType.TEST, 2, 2))).howMany(ShipmentType.YELLOW));
        assertArrayEquals(new int[]{0,0,0,1,0}, player2.getSpaceShip().getContains());
