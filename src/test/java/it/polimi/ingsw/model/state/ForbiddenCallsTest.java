...
public class ForbiddenCallsTest {
    ...
    public void forbidden(){
        ...
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb1));
        ServerMessage forb2 = new SetCrewMessage(c, a);
        forb2.setDescriptor(p1desc);
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb2));
		ServerMessage forbtc = new PutComponentMessage(1, c, ComponentRotation.U000);
        forbtc.setDescriptor(p1desc);
        assertThrows(ForbiddenCallException.class, () -> state.validate(forbtc));
        ServerMessage forb3 = new ToggleHourglassMessage();
        forb3.setDescriptor(p1desc);
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb3));
        ServerMessage forb5 = new TakeComponentMessage();
        forb5.setDescriptor(p1desc);
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb5));
        ServerMessage forb6 = new DiscardComponentMessage();
        forb6.setDescriptor(p1desc);
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb6));
        ServerMessage forb7 = new TakeDiscardedComponentMessage(132);
        forb7.setDescriptor(p1desc);
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb7));
        ServerMessage forb8 = new RemoveComponentMessage(c);
        forb8.setDescriptor(p1desc);
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb8));
        ServerMessage forb9 = new SelectBlobMessage(c);
        forb9.setDescriptor(p1desc);
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb9));
        ServerMessage forb10 = new PlayerGiveUpMessage();
        forb10.setDescriptor(p1desc);
		assertThrows(ForbiddenCallException.class, ()->state.getCardState(player1));
        assertThrows(ForbiddenCallException.class, () -> state.validate(forb10));
