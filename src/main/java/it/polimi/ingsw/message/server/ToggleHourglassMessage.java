...
/**
 * Server message indicating a request from a player to toggle the hourglass during the construction phase.
 */
public class ToggleHourglassMessage extends ServerMessage {
	...
	public void receive(GameState state) throws ForbiddenCallException {
		state.toggleHourglass(this.descriptor.getPlayer());
	}
