...
public class ClientUnfinishedGameListEntry implements Serializable {
    ...
    public ClientUnfinishedGameListEntry(GameModeType type, String state, HashMap<PlayerColor, String> players, int model_id){
