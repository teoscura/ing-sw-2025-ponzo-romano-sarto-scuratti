...
public interface iPlanche extends Serializable {
	 ...
	 *
	 * @param p {@link Player} The player being searched.
	 ...
	 * @return {@link Player} The player on the cell, or null if nobody occupies it.
	 */
	 ...
	 *
	 * @param state {@link VoyageState} The state currently being played.
	 * @param p {@link Player} The player being moved.
