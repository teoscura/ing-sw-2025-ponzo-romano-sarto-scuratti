...
public abstract class GameState implements Serializable {
	...
	public void connect(ClientDescriptor client) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Client: '" + client.getUsername() + "' tried to connect in a state that doesn't allow it!");
	...
	public void disconnect(ClientDescriptor client) throws ForbiddenCallException {
		this.broadcastMessage(new ViewMessage("Client: '" + client.getUsername() + "' tried to disconnect in a state that doesn't allow it!"));
		/*XXX*/System.out.println("Client: '" + client.getUsername() + "' tried to disconnect in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void sendContinue(Player p) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to send a continue in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void putComponent(Player p, ShipCoords coords, ComponentRotation rotation) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to put a component in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void takeComponent(Player p) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to pick a component in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void takeDiscarded(Player p, int id) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to take a discarded component in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void discardComponent(Player p, int id) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to discard a component in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void toggleHourglass(Player p) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to toggle the hourglass in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void removeComponent(Player p, ShipCoords coords) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to remove a component in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void setCrewType(Player p, ShipCoords coords, AlienType type) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to set the crew type in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void giveUp(Player p) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to give up in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public void selectBlob(Player p, ShipCoords blob_coord) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to select a new blob in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
	...
	public CardState getCardState(Player p) throws ForbiddenCallException {
		...
		/*XXX*/System.out.println("Player: '" + p.getUsername() + "' tried to get the card state in a state that doesn't allow it!");
		throw new ForbiddenCallException("This state doesn't support this function.");
	}
