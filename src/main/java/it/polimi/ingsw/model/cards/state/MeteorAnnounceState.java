...
public class MeteorAnnounceState extends CardState {
	...
	/**
	 * Validates the {@link it.polimi.ingsw.message.server.ServerMessage} and if everyone motioned to progress, hits everyone with the same meteorite and transitions.
	 *
