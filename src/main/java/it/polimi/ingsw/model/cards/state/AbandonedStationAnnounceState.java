...
/**
 * Class representing an Announce State of the {@link AbandonedStationCard}.
 */
public class AbandonedStationAnnounceState extends CardState {
	...
	public void init(ClientState new_state) {
		...
		Logger.getInstance().print(LoggerLevel.MODEL, "[" + state.getModelID() + "] " + "New CardState -> Abandoned Station Announce State!");
