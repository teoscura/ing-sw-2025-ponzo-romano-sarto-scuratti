...
/**
 * Class representing the Announce State of the {@link SlaversCard}.
 */
public class SlaversAnnounceState extends CardState {
	...
	/**
	 * Construct a {@link SlaversAnnounceState} object.
	 * 
	...
	public void init(ClientState new_state) {
		...
		if (list.size() == this.state.getCount().getNumber())
			Logger.getInstance().print(LoggerLevel.MODEL, "[" + state.getModelID() + "] " + "New CardState -> Slavers Announce State!");
		else
			Logger.getInstance().print(LoggerLevel.MODEL, "[" + state.getModelID() + "] " + "CardState -> Slavers Announce State!");
