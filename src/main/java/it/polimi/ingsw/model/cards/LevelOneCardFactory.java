	...
	public LevelOneCardFactory() {
		this.cards = new HashMap<Integer, iCard>() {{
			...
			put(12, new PlanetCard(12, 3,
					new Planet[]{
							new Planet(0, new int[]{3, 1, 0, 1}),
							new Planet(1, new int[]{1, 0, 1, 1}),
							new Planet(2, new int[]{3, 0, 0, 1}),
							new Planet(3, new int[]{0, 1, 0, 1})})
			);
			put(13, new PlanetCard(13, 2,
					new Planet[]{
							new Planet(0, new int[]{0, 0, 0, 2}),
							new Planet(1, new int[]{2, 0, 0, 1}),
							new Planet(2, new int[]{0, 0, 1, 0})})
			);
			put(14, new PlanetCard(14, 3,
					new Planet[]{
							new Planet(0, new int[]{2, 1, 1, 0}),
							new Planet(1, new int[]{0, 0, 2, 0})})
			);
			put(15, new PlanetCard(15, 1,
					new Planet[]{
							new Planet(0, new int[]{0, 2, 0, 0}),
							new Planet(1, new int[]{0, 0, 1, 0}),
							new Planet(2, new int[]{3, 0, 0, 0})})
			);
