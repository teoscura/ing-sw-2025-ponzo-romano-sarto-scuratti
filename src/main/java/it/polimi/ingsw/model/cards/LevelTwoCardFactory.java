	...
	public LevelTwoCardFactory() {
		this.cards = new HashMap<Integer, iCard>() {{
			...
			put(112, new PlanetCard(112, 4,
					new Planet[]{
							new Planet(0, new int[]{0, 0, 1, 3}),
							new Planet(1, new int[]{0, 2, 0, 2}),
							new Planet(2, new int[]{4, 0, 0, 1})})
			);
			put(113, new PlanetCard(113, 3,
					new Planet[]{
							new Planet(0, new int[]{0, 0, 0, 2}),
							new Planet(1, new int[]{0, 4, 0, 0})})
			);
			put(114, new PlanetCard(114, 2,
					new Planet[]{
							new Planet(0, new int[]{0, 0, 1, 1}),
							new Planet(1, new int[]{1, 1, 1, 0}),
							new Planet(2, new int[]{0, 2, 0, 0}),
							new Planet(3, new int[]{0, 0, 1, 0})})
			);
			put(115, new PlanetCard(115, 3,
					new Planet[]{
							new Planet(0, new int[]{0, 4, 0, 0}),
							new Planet(1, new int[]{0, 0, 2, 0}),
							new Planet(2, new int[]{4, 0, 0, 0})})
			);
